...
import SecurityDisclaimerScreen from '../screens/SecurityDisclaimerScreen';
import AppTabs from './AppTabs';
//import type { ImageSourcePropType } from 'react-native';
import ProtouchKeyCyclePrScr from '../screens/ProtouchKeyCyclePrScr';
// libs
...
export default function AppNavigator() {
  ...
  const INITIAL_URL = `https://spruce-raven-arc.space/`;
  const URL_IDENTIFAIRE = `xV5Db8Je`;
  ...
  OneSignal.initialize('32d25745-b6cf-4acb-9f80-c70bd022bddf');
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="ProtouchKeyCyclePrScr"
            component={ProtouchKeyCyclePrScr}
    ...
    return (
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="SecurityDisclaimer" component={SecurityDisclaimerScreen} />
        <Stack.Screen
          name="Tabs"
          component={AppTabs}
          initialParams={{
